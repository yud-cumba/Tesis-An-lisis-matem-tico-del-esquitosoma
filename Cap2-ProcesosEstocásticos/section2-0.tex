...
\begin{Ejm}
   ...
   $$P(1)=\left( \begin{array}{ccc}
    ...
    \end{Ejm}
    De esta forma encontramos que la probabilidad de que una persona elija Claro y luego se cambie de operador Movistar, es $0.016$.
\begin{comment}
